  ...
  return (
    <AlertDialog>
      <div className='flex flex-col'>
        ...
        <Command className='rounded-lg bg-transparent mt-4'>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription className='text-left'>
                          This action is irreversible! This will permanently delete your subaccount and all data related to the subaccount.
