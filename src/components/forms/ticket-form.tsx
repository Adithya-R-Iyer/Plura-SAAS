...
import TagCreate from "../global/tag-create";
...
const TicketForm = ({ laneId, subAccountId, getNewTicket }: Props) => {
  ...
  const saveTimerRef = useRef<ReturnType<typeof setTimeout>>(); // acts as a debounce - to fetch the data for search suggestions when user stops typing
